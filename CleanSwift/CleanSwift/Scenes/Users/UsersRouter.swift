...
class UsersRouter: NSObject, UsersRoutingLogic, UsersDataPassing {
    ...
    //func navigateToSomewhere(source: UsersViewController, destination: SomewhereViewController)
    //{
    ...
    //func passDataToSomewhere(source: UsersDataStore, destination: inout SomewhereDataStore)
    //{
